...
async def list_models(
    ...
    """Get a list of available OpenAI models (compatible with Gemini and OpenAI)."""
...
async def chat_completion(
    ...
    """Handles OpenAI chat completion requests, supports streaming responses and specific model switching."""
...
async def get_keys_list(
    ...
    """Get a list of valid and invalid API keys (requires management Token authentication)."""
