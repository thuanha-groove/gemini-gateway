...
class ImageCreateService:
    ...
    def parse_prompt_parameters(self, prompt: str) -> tuple:
        ...
        Supported formats:
        - {n:count} e.g., {n:2} to generate 2 images
        - {ratio:aspect_ratio} e.g., {ratio:16:9} to use 16:9 aspect ratio
        """
        import re
    ...
    def generate_images(self, request: ImageGenerationRequest):
        ...
        # If n is specified in the prompt, override the n in the request
        if prompt_n > 1:
            request.n = prompt_n

        # If ratio is specified in the prompt, override the default aspect_ratio
